...
const services = [
  {
    title: "Data Analyst",
    description: 'Pasionate about data and skilled in Python, SQL, Excel and data visualization tools like Tableau and PowerBI',
    icon: (
  ...
  },
  {
    ...
    description: 'Skilled in JavaScript and backend systems using Node.js and Express, with experience in RESTful APIs and databases PostgreSQL.',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="42" height="42" viewBox="0 0 42 42" className="mr-4">
        <path d="M18,34.111l-1.667,6.667L14.111,43H31.889l-2.222-2.222L28,34.111M3,25.222H43M7.444,34.111H38.556A4.444,4.444,0,0,0,43,29.667V7.444A4.444,4.444,0,0,0,38.556,3H7.444A4.444,4.444,0,0,0,3,7.444V29.667A4.444,4.444,0,0,0,7.444,34.111Z" transform="translate(-2 -2)" fill="none" stroke="#fff" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"/>
      </svg>
    ),
  },
  {
    title: "Front End Developer",
    description: 'Skilled in HTML, CSS, JS and React frameworks. Pasionate about User Experience and Design.',
    icon: (
...
const experiences = [
  ...
  { 
    ...
    iconBg: "#383E56", 
    points: [
      "Data Analytics bootcamp at CareerFoundry.",
      "Working at Indigo Volunteers NGO as Tech Assistant.",
      "First hands-on experience with web development and data analytics.",
    ]
  }
];
...
export { services, experiences, projects, filters };